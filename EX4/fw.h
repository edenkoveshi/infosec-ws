...
typedef enum {
	...
	REASON_VALID_CONNECTION		 = -8,
	REASON_INVALID_CONNECTION    = -9,
} reason_t;
...
#define IN_NET_DEVICE_NAME			"eth0"
#define OUT_NET_DEVICE_NAME			"eth1"
...
#define BYTE 			8
#define PROXY_IP		0x0a000205 //10.0.2.5
...
typedef struct {
	...
	unsigned int  	action;       	// valid values: NF_ACCEPT, NF_DROP
